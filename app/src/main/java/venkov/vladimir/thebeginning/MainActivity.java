...
public class MainActivity extends DaggerAppCompatActivity {
    ...
    @OnItemClick(R.id.btn_start_login_activity)
    public void onBtnLoginClick() {
        Intent intent = new Intent(this, LoginActivity.class);
        startActivity(intent);
    }

    @OnItemClick(R.id.btn_start_accommodations_list_activity)
    public void onBtnAccommodationsClick() {
        Intent intent = new Intent(this, AccommodationsListActivity.class);
        startActivity(intent);
    }

    @OnItemClick(R.id.btn_start_chat_activity)
    public void onChatClick() {
        Intent intent = new Intent(this, ChatActivity.class);
        startActivity(intent);
    }

    @OnItemClick(R.id.btn_start_users_list_activity)
